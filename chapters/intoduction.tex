LaTeX is a document preparation system. This means that uses markup tagging commands to structure and stylise the document as well as adding citations, footnotes etc. The writing in LaTeX is done in plan text and the document can then generate a PDF file. 
